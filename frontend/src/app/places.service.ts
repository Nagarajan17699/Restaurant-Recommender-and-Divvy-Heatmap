...
////////////////////////////////////////////////////////////////////////////////////
  ...
  get_all_divvy_stations_data_custom_data(timeRange, newTimeRangeSelection){
    const find_stations_at = {
    ...
    return this.http.post(`${this.uri}/stations/fetch_all_divvy_stations_data_custom_data`, find_stations_at, httpOptions);
  ...
  findPlaces(find, where) {
    ...
    if(this.containsAnyLetters(where))
      return this.http.post(`${this.uri}/places/find`, find_places_at, httpOptions);

    return this.http.post(`${this.uri}/places/find_with_zip`, find_places_at, httpOptions);
